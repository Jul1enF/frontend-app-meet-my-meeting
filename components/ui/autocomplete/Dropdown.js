        ...
        >
            <FlatList
                ...
                keyExtractor={(item, index) => {
                    if (valueKey && item[valueKey]._id) return item[valueKey]._id
                ...
                renderItem={({ item, index }) =>
                    <TouchableOpacity onPress={() => {
                        setSelectedItem(valueKey ? item[valueKey] : item )
                        closeDropdown()
                    }} >
