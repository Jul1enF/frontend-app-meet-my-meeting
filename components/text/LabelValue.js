...
export default function LabelValue ({ label, details, underlineOffset = phoneDevice ? RPW(1) : 10, underlineHeight = phoneDevice ? 3 : 4.5, underlineColor = appStyle.strongBlack, labelStyle, detailsStyle, index, lastIndex, margin = phoneDevice ? RPW(1.5) : 12, extraSpace = true }) {
