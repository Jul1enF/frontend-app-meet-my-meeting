...
export default function WorkingOverrideSaving({ oldEvent, workingSchedule, resetAndRenewEvents }) {
    ...
    return (
        <>
            ...
            <Button func={eventValidation} text={`${oldEvent?.category === "dayOff" ? "Rajouter" : "Modifier"} ce jour de travail`} style={{ ...appStyle.mediumItemHeight, marginTop: appStyle.largeMarginTop, width : "100%" }} fontStyle={{ ...appStyle.largeText, color: appStyle.fontColorDarkBg, letterSpacing: phoneDevice ? RPW(0.3) : 2 }} />
