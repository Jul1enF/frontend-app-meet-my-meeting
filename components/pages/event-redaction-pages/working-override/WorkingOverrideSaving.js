...
export default function WorkingOverrideSaving({ oldEvent, workingSchedule, resetAndRenewEvents }) {
    ...
    return (
        <>
            ...
            <Button func={eventValidation} text={`${oldEvent?._id ? "Enregistrer" : "Modifier"} cette journée de travail`} style={{ height: appStyle.mediumItemHeight, marginTop: appStyle.largeMarginTop, width : "100%" }} fontStyle={{ ...appStyle.largeText, color: appStyle.fontColorDarkBg, letterSpacing: phoneDevice ? RPW(0.3) : 2 }} />
