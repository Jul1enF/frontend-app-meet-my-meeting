    ...
    if (!userIsConnecting || jwtToken) {
        return (
            <View style={{ paddingBottom: appStyle.largeMarginTop, width: "100%", alignItems: "center" }} >
                ...
                <Button func={buttonFunction} text={buttonText} style={{width : appStyle.largeItemWidth, height: appStyle.largeItemHeight, marginTop : appStyle.largeMarginTop }} fontStyle={{ ...appStyle.labelText, color: appStyle.fontColorDarkBg, letterSpacing: phoneDevice ? RPW(0.3) : 2 }} />
